...
const lv_img_dsc_t *ui_imgset_gif[3] = {&ui_img_gif1_png, &ui_img_gif2_png, &ui_img_gif3_png};
...
lv_anim_set_values(&PropertyAnimation_1, 0, 5 );
...
ui_anim_user_data_t *PropertyAnimation_0_user_data = lv_mem_alloc(sizeof(ui_anim_user_data_t));
PropertyAnimation_0_user_data->target = TargetObject;
PropertyAnimation_0_user_data->imgset = (lv_img_dsc_t **)ui_imgset_gif;
PropertyAnimation_0_user_data->imgset_size = sizeof(ui_imgset_gif)/(sizeof(lv_img_dsc_t*));
PropertyAnimation_0_user_data->val = -1;
lv_anim_t PropertyAnimation_0;
lv_anim_init(&PropertyAnimation_0);
